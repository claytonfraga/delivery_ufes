...
//        
	...
	void CT006() {
		...
		OperacaoInvalidaException thrown = assertThrows( OperacaoInvalidaException.class, () -> pedido.incluir( new ItemPedido( pedido, dao.buscaProdutoPorCodigo( 7 ), 2 ) ), "Espera-se que incluir() um mesmo item ao pedido levante uma exceção" );
	...
	void CT008() {
		...
		// Act
		OperacaoInvalidaException thrown = assertThrows( OperacaoInvalidaException.class, () -> pedido.removeItem( "Creme de Leite" ), "Espera-se que removeItem()." );

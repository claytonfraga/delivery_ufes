...
public class IngridTests {
    ...
    @Test
    @DisplayName("Verifica se o método getValorTotalImpostos da classe Pedido "
            + "retorna o valor total dos impostos corretamente")
    public void CT001() {
    ...
    @Test
    @DisplayName("Verifica se o método getValorFinal da classe Pedido "
            + "retorna o valor final do pedido com os impostos e descontos corretamente")
    public void CT002() {
    ...
    @Test
    @DisplayName("Verifica se o método getValorTotalDescontos da classe Pedido "
            + "retorna o valor total dos descontos corretamente")
    public void CT003() {
    ...
    @Test
    @DisplayName("Verifica se o método getValorTotal da classe Pedido "
            + "retorna o valor total do pedido corretamente")
    public void CT004() {
    ...
    @Test
    @DisplayName("Verifica se o método getNroSequencialPedido() da classe PedidoDAO"
            + " retorna o número de pedidos corretamente")
    void CT005() {
    ...
    @Test
    @DisplayName("Verifica se o método getInstance da classe PedidoDAO "
            + "não retorna uma instancia nula")
    public void CT006() {
    ...
    @Test
    @DisplayName("Verifica se o método getInstance da classe ProdutoDAO "
            + "não retorna uma instancia nula")
    public void CT007() {
    ...
    @Test
    @DisplayName("Verifica se o sistema lança a exceção quando a quantidade passada "
            + "para o método verificaQuantidade da classe ProdutoDAO é menor que 0")
    public void CT008() {
    ...
    @Test
    @DisplayName("Verifica se o método getDescontosConcedidos da classe Pedido "
            + "retorna todos os descontos do pedido corretamente")
    public void CT009() {
    ...
    @Test
    @DisplayName("Verifica se o método getImpostos da classe Pedido "
            + "retorna os impostos do pedido corretamente")
    public void CT010() {

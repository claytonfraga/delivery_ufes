...
public class JuliaTests {
    ...
    void CT001() {
        ...
        String info = " Produto: " + produto.getNome() + ", código: " + produto.getCodigo()
                + ", preço unitário: " + df.format(produto.getPrecoUnitario())
                + ", quantidade em estoque: " + df.format(produto.getQuantidadeEmEstoque());
    ...
    void CT007() {
        ...
        DecimalFormat df = new DecimalFormat("0.00");
        String info = "Item: " + item.getNomeProduto()
                + ", quantidade: " + df.format(item.getQuantidade())
                + ", preço unitário: R$ " + df.format(item.getValorUnitario())
                + ", preço total do item: R$ " + df.format(item.getValorTotal());

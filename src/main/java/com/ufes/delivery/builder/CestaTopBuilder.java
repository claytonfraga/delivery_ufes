...
public class CestaTopBuilder extends CestaBuilder {
	...
	public void addOutros() {
		pedido.incluir( new ItemPedido( pedido, dao.buscaProdutoPorCodigo( 26 ), 6 ) );
		pedido.incluir( new ItemPedido( pedido, dao.buscaProdutoPorCodigo( 25 ), 6 ) );
		pedido.incluir( new ItemPedido( pedido, dao.buscaProdutoPorCodigo( 24 ), 6 ) );
	}
